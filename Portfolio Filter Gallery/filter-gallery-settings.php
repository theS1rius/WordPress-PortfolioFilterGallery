...
<div class="row gallery-content-photo-wall">
	...
	<div class="kwt-file">
		<div class="kwt-file__drop-area">
			...
			<span class="kwt-file__msg">新增 / 上傳檔案</span>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
			<div class="list-group">
				<a href="#" class="list-group-item active">
					...
					<?php _e('相片', 'portfolio-filter-gallery'); ?>
				</a>
				<a href="#" class="list-group-item">
					<span class="dashicons dashicons-admin-generic"></span>
					<?php _e('配置', 'portfolio-filter-gallery'); ?>
				</a>
				<a href="#" class="list-group-item">
					<span class="dashicons dashicons-editor-insertmore"></span>
					<?php _e('篩選器', 'portfolio-filter-gallery'); ?>
				</a>
				<a href="#" class="list-group-item">
					<span class="dashicons dashicons-welcome-view-site"></span>
					<?php _e('圖片檢視器', 'portfolio-filter-gallery'); ?>
				</a>
				<a href="#" class="list-group-item">
					<span class="dashicons dashicons-media-code"></span>
					<?php _e('自訂 CSS', 'portfolio-filter-gallery'); ?>
				</a>
				...
				<a href="#" class="list-group-item" style="background:#f6f7f7a6;">
					...
					<?php _e('載入更多', 'portfolio-filter-gallery'); ?>
				</a>

				<a href="#" class="list-group-item" style="background:#f6f7f7a6;">
					<span class="dashicons dashicons-unlock"></span>
					<?php _e('升級到專業版', 'portfolio-filter-gallery'); ?>
				</a>
			</div>
		</div>
			...
			<div class="bhoechie-tab-content active">
				...
				<div id="image-gallery">
					...
					<input type="button" id="remove-all-images" name="remove-all-images"
						...
						value="<?php _e('刪除全部圖片', 'portfolio-filter-gallery'); ?>">
					<div class="btn-group" id="sort-all-slides">
						<button onclick="return SortSlides('Shuffle');" type="button"
							...
							<?php _e('隨機播放', 'portfolio-filter-gallery'); ?>
						</button>
					</div>
			...
			<div class="bhoechie-tab-content">
				...
				<div class="pw_grid_layout_config">
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('縮圖尺寸', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('選擇縮圖尺寸', 'portfolio-filter-gallery'); ?>
								</p>
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field panel-body">
								...
								<select id="gal_size" name="gal_size" class="selectbox_settings form-control">
									<option value="thumbnail" <?php if ($gal_size == "thumbnail")
										echo "selected=selected"; ?>>
										<?php _e('縮圖 - 150 x 150', 'portfolio-filter-gallery'); ?>
									</option>
									<option value="medium" <?php if ($gal_size == "medium")
										echo "selected=selected"; ?>>
										<?php _e('中 - 300 x 169', 'portfolio-filter-gallery'); ?>
									</option>
									<option value="large" <?php if ($gal_size == "large")
										echo "selected=selected"; ?>>
										<?php _e('大 - 840 x 473', 'portfolio-filter-gallery'); ?>
									</option>
									<option value="full" <?php if ($gal_size == "full")
										echo "selected=selected"; ?>>
										<?php _e('最大 - 1280 x 720', 'portfolio-filter-gallery'); ?>
									</option>
								</select>
							</div>
						</div>
					...
					<div id="" class="meta_box_holder_inside">
						<h2>
							<?php _e('欄位設置', 'portfolio-filter-gallery'); ?>
						</h2>
						<div class="row">
							<div class="col-md-4">
								<div class="ma_field_discription">
									<h4>
										<?php _e('桌面版欄位', 'portfolio-filter-gallery'); ?>
									</h4>
									<p>
										<?php _e('選擇欄位數量', 'portfolio-filter-gallery'); ?>
									</p>
								</div>
							</div>
							<div class="col-md-8">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="ma_field_discription">
									<h4>
										<?php _e('平板版欄位', 'portfolio-filter-gallery'); ?>
									</h4>
									<p>
										<?php _e('選擇欄位數量', 'portfolio-filter-gallery'); ?>
									</p>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="ma_field_discription">
									<h4>
										<?php _e('手機橫向版欄位', 'portfolio-filter-gallery'); ?>
									</h4>
									<p>
										<?php _e('選擇欄位數量', 'portfolio-filter-gallery'); ?>
									</p>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="ma_field_discription">
									<h4>
										<?php _e('手機垂直版欄位', 'portfolio-filter-gallery'); ?>
									</h4>
									<p>
										<?php _e('選擇欄位數量', 'portfolio-filter-gallery'); ?>
									</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('排序方向', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('選擇排序方向', 'portfolio-filter-gallery'); ?>
								</p>
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field panel-body">
								<p class="switch-field em_size_field">
									...
									<label for="gallery_direction1">
										<?php _e('右到左', 'portfolio-filter-gallery'); ?>
									</label>
									...
									<label for="gallery_direction2">
										<?php _e('左到右', 'portfolio-filter-gallery'); ?>
									</label>
								</p>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('游標停留效果', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('選擇游標停留效果', 'portfolio-filter-gallery'); ?>
								</p>
							</div>
						</div>
						<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('縮圖邊框', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('要縮圖邊框嗎', 'portfolio-filter-gallery'); ?>
								</p>
							</div>
						</div>
						<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('隱藏縮圖間距', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('要隱藏嗎', 'portfolio-filter-gallery'); ?>
								</p>
							</div>
						</div>
						<div class="col-md-8">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('縮圖標題', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('縮圖標題', 'portfolio-filter-gallery'); ?>
								</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h4>
									<?php _e('在縮圖上顯示編號', 'portfolio-filter-gallery'); ?>
								</h4>
								<p>
									<?php _e('在縮圖上顯示編號', 'portfolio-filter-gallery'); ?>
								</p>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ma_field_discription">
							<h4>
								<?php _e('影像灰階效果', 'portfolio-filter-gallery'); ?>
							</h4>
							<p>
								<?php _e('影像灰階', 'portfolio-filter-gallery'); ?>
							</p>
						</div>
					</div>
					<div class="col-md-8">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ma_field_discription">
							<h4>
								<?php _e('影像根據標題排列', 'portfolio-filter-gallery'); ?>
							</h4>
							<p>
								<?php _e('影像根據標題排列', 'portfolio-filter-gallery'); ?>
							</p>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ma_field_discription">
							<h4>
								<?php _e('開啟圖片連結方式', 'portfolio-filter-gallery'); ?>
							</h4>
							<p>
								<?php _e('開啟圖片連結方式', 'portfolio-filter-gallery'); ?>
							</p>
