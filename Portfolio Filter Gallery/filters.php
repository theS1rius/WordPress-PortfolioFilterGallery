				...
				<div class="container">
					<div class="form-btns text-center">
						<input type="button" class="pfg-btn button-primary button-hero " id="save_category"
							name="save_category" value="<?php _e('新增分類', 'portfolio-filter-gallery'); ?>"
					...
					<div id="cat-table-div">
							...
							<thead>
								<tr>
									...
									<th class="row-title"><strong>
											<?php _e('分類名稱', 'portfolio-filter-gallery'); ?>
										</strong></th>
									<th class="row-title"><strong>
											<?php _e('動作', 'portfolio-filter-gallery'); ?>
										</strong></th>
								...
								<tr>
									...
									<?php if ($all_category) {
										...
										<td class="text-center">
											<input type="button" class="pfg-btn button-primary button-hero lower-btn"
												value="<?php _e('刪除全部', 'portfolio-filter-gallery'); ?>"
						...
						<?php if (count($all_category) == 7) { ?>
							<h5 class="notice notice-info notice-alt">
								<?php _e('只能在免費版本添加最多7個分類', 'portfolio-filter-gallery'); ?>
